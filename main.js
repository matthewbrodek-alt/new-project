const projectData = {
    residences: [
        { title: "Eden Residences", phase: "Phase 1", distance: "50m to Beach", img: "eden-render.jpg" },
        { title: "Park Residences", phase: "Phase 2", distance: "300m to Beach", img: "park-render.jpg" },
        { title: "Lake Residences", phase: "Phase 3", distance: "500m to Beach", img: "lake-render.jpg" }
    ],
    infrastructure: [
        { title: "Underground Parking", description: "Secure parking with direct elevator access.", icon: "parking.svg", category: "Safety" },
        { title: "Infinity Pool", description: "Olympic-sized pool with ocean views.", icon: "pool.svg", category: "Leisure" },
        { title: "Etro Cafe", description: "Artistic dining space by Etro Home.", icon: "cafe.svg", category: "Lifestyle" },
        { title: "Fitness & Yoga", description: "Modern gym and outdoor yoga decks.", icon: "fitness.svg", category: "Health" },
        { title: "Concierge 24/7", description: "Personal assistance for any request.", icon: "concierge.svg", category: "Service" },
        { title: "Kids' Club", description: "Eco-friendly play areas for education.", icon: "kids.svg", category: "Family" }
    ]
};

// Функция отрисовки (Оригинальная логика)
...
document.addEventListener('click', (e) => {
    if (e.target.closest('.residence-card') || e.target.innerText.includes('EXPLORE')) {
